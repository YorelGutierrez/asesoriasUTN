...
<div class="row" id="lista-alumnos">
    @forelse($alumnos as $alumno) {{-- antes era $item --}}
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 alumno-card"
        data-nombre="{{ strtolower($alumno->user->apellido_paterno . ' ' . $alumno->user->apellido_materno . ' ' . $alumno->user->nombres) }}">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a class="btn-principal" href="{{ route('expedienteAlumnos', $alumno->id) }}">Seleccionar alumno</a>
